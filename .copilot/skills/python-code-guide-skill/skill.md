...
description: Apply PEP 8 Python code style standards when writing, reviewing, or refactoring Python code. Use this skill when the user asks to enforce Python coding style, review Python code formatting, write production-grade Python, fix style issues, organize imports, apply naming conventions, or follow Python best practices. Derived from PEP 8 — the official Style Guide for Python Code.
license: Public domain. Original PEP 8 by Guido van Rossum, Barry Warsaw, Alyssa Coghlan.
---

This skill encodes the official Python code style standards from PEP 8. When applied, Claude enforces these rules for all Python code — covering layout, whitespace, naming, comments, and programming best practices.

The user may ask for code review, generation, refactoring, or style compliance checking. Apply whichever sections are relevant.
